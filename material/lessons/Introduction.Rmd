...
Allows you to make some graphics, but you are limited by the program to what type and how do they look | Allows you to customize every aspect of your visualization
You fo through your analyzing process once and you can forget about making it immediately reproducible for someone else | Allows you to save the code through which you processed your database. This makes the whole methodology immediately reproducible by anyone else whom you shared the script with.
... | ...
