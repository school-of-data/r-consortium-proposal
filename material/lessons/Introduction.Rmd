...
## and 0 otherwise
mydata$result <- ifelse(mydata$Pct_Remain < 50, 1, 0)
...
mydata$Remain_cat <- cut(mydata$Pct_Remain, breaks = c(0, 25, 50, 75, 100))
...
datahasc$Pct_remain <- (datahasc$Remain / datahasc$Valid_Votes)*100
datahasc$Pct_leave <- (datahasc$Leave/ datahasc$Valid_Votes)*100
