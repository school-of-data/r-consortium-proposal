...
This problem is compounded by several other factors, that we explored in a small worldwide survey that we conducted in preparation for this call for project. It appeared that, among the journalists who had never taken an R course, the main reason was the lack of learning content addressing their specific needs. Another substantial portion had never heard of R (cf. Annex 1).  This strengthens our main hypothesis:  there is a need for learning content specially designed for journalists.
...
With the help of the survey results, we refined our initial idea of created journalism-specific learning content into a series of learning modules organised into tracks.  While the early introductory modules will be fully written by our team in order to fully tailor them to journalists, we plan to use the tracks as a way to curate existing R learning content available online, making into contextually useful for journalists. When necessary we will also translate this content to make it useful for non-English speakers.
