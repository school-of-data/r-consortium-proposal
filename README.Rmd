...
With the help of the survey results (see Annex 1), we refined our initial idea of created journalism-specific learning content into a series of learning modules organised into tracks and based on real projects.  While the early introductory modules will be fully written by our team in order to fully tailor them to journalists, we plan to use the tracks as a way to curate existing R learning content available online, making into contextually useful for journalists. When necessary we will also translate this content to make it useful for non-English speakers.
